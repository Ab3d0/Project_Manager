...
import { ChartNoAxesColumnDecreasing, FileImage } from 'lucide-react'
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if(!data.success){
                ...
                toast.error("Veuillez crée avec succès")
                ...
                <section className="flex md:flex-row flex-col">
                    <div className='space-y-4 md:w-[450px]'>
                        ...
                        >
                            ...
                            <option value="hg">Kilogramme</option>
                        ...
                        <input 
                            ...
                            accept='image/'
                            placeholder='Prix'
                            className='file-input file-input input-bordered w-full'           
                    ...
                    <div className='md:ml-4 md:w-[300px] mt-4 md:mt-0 border-2 border-primary md:h-[300px] p-5 flex justify-center items-center rounded-3xl'>
                        {previewUrl && previewUrl !=="" ? (
                            ...
                            <div className="wiggle-anigmation">
